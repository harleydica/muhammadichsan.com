...
**Proxy** dari katanya ia memiliki arti sebagai penengah antara dua node yang saling berkomunikasi. Dalam penggunaanya di internet sebuah server yang bertindak sebagai server nantinya ia akan berada di tengah-tengah antara client dan server dimana semua request dan response yang ada pasti akan di melewati proxy server terlebih dahulu.
