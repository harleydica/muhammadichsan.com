...
Yap pertanyaan tersebut sempat terlintas di pikiran saya saat saya memepelajari service di aws pertama kali, dengan seiiringnya waktu saya mengetahui bahwa kebanyakan perusahaan atau startup yang menggunakan cloud di AWS dia hanya membuat 1 akun saja, menurut saya hal ini dikarenakan oleh beberapa faktor ini.
