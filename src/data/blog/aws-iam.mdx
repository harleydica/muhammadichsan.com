...
Jika anda mempunyai banyak developer dengan tugas yang berbeda-beda maka fitur ini akan bermanfaat bagi anda dalam mengelompokkan user developer sesuai tugasnya. Misal kita mempunyai 25 pegawai yang mempunyai tugas yang berbeda satu sama yang lain, ada 4 orang bertindak sebagai devops, 10 orang sebagai IoT dev, dan sisanya mungkin backend. Dengan users group setiap user tersebut bisa kita masukan kedalam satu grup dimana semua user IAM yang berada di dalam satu grup yang sama akan mempunyai permission dan policy yang sama terhadap suatu resource.