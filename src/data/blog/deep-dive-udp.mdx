...
Dari namanya saja kita sudah mengetahui fungsi dari atribut ini, length = panjang dan data yaitu payload atau kumpulan informasi yang akan kita kirim. Atribut length data berisikan panjang 
