...
> Sistem operasi memiliki limit number port hingga 65532 hal ini diambil dari 2^16 yaitu ukuran 2 byte, port dari 1-1023 disebut sebagai well-known port, dan sisanya merupakan port yang bisa kita sesuka hati
