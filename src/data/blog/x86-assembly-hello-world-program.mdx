...
> In this tutorial i use x86-32 bit assembly with NASM assembler and Debian distro. My syntax and writing procedures follow with NASM, maybe each assembler is different.
